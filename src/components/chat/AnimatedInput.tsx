          ...
          >
            ...
            {modesToggleVisible && onToggleModes && (
              <motion.button
                ...
                className="theme-fixed shrink-0 inline-flex w-9 h-9 md:w-10 md:h-10 items-center justify-center rounded-full !bg-transparent border-0 text-white hover:text-white transition-colors"
            ...
            <AnimatePresence mode="popLayout" initial={false}>
              {isLoading ? (
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  onClick={onCancel}
                  className="theme-fixed shrink-0 w-9 h-9 md:h-10 md:w-10 flex items-center justify-center rounded-full bg-white text-black shadow-[0_2px_10px_rgba(0,0,0,0.3)] hover:opacity-90 transition-opacity"
